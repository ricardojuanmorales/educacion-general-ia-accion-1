...
| DEUDA-EGIA-011 | P2 | La economía de puntos se calibró para 8 retos; con 15 retos y dilemas ramificados los umbrales Q0–Q6 quedan desajustados | Marco de Competencias v0.1 | Umbrales recalculados y probados | **Resuelta** 2026-08-31 por DEC-EGIA-044: el nivel deja de calcularse con umbrales de puntos y pasa a calcularse por recorrido. La deuda se cierra eliminando el mecanismo, no recalibrándolo |
...
| DEUDA-EGIA-025 | P3 | El glosario (38 términos) y las fichas de herramienta (8) están validados y aprobados pero no tienen pantalla. El contenido existe; la interfaz no | Fase 3, alcance acordado | Secciones de glosario y herramientas en la aplicación | **Resuelta** 2026-08-31: ambas secciones publicadas, con búsqueda sin acentos, remisiones navegables y la rejilla completa por ficha |
| DEUDA-EGIA-027 | P2 | El reparto de retos por nivel es irregular: Q3 tiene un solo reto y Q5 tiene cuatro. Cualquier esquema de nivel basado en puntos hereda esa forma, y bajo un esquema por recorrido el único reto de Q3 se vuelve puerta obligatoria hacia la mitad superior | Análisis de umbrales 2026-08-31 | Decisión humana sobre si el reparto se mantiene a propósito o se reequilibra; toca contenido aprobado (DEC-EGIA-040) | Abierta · F3 |
